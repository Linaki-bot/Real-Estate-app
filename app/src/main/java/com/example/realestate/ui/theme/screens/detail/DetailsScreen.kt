...
import com.example.realestate.ui.theme.purple
...
fun DetailsScreen(navController: NavController){
    ...
    Column(modifier = Modifier.fillMaxSize()){
        ...
        TopAppBar(
            title = { Text(text = "MagicBricks", fontFamily = FontFamily.Cursive)},
            colors = TopAppBarDefaults.mediumTopAppBarColors(purple),
            navigationIcon = {
            ...
            contentAlignment = Alignment.Center)
        {
            ...
            Text(
                text = "Choose your suitable property",
                fontSize = 40.sp,
                color = Color.Black,
